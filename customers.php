...
<meta name="author" content="Suraj Mujalde">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<script src="https://kit.fontawesome.com/030c849e74.js" crossorigin="anonymous"></script>
<link rel = "icon" href ="images/finalbanklogo.png" type = "image/x-icon">
<title>Customers | Bank of Indore</title>
<style>
body {
margin:0;
padding:0;
...
height: 100px;
position:relative;
background-color: rgb(117, 9, 160);
}
...
.fixed-header {
background-color: rgb(44, 199, 204);
height: 50px;
line-height: 45px;
width: 100%;
text-align: center;
...
<section class="page-header">
    <div class="header">
        <div class="header-left"> 
            <img src="images/finalbanklogo.png" class="header-left-logo">
        </div>    
...
<section class="page-footer">
    <footer class="footer-distributed">
        <div class="footer-left">
            <h2>Bank of <span>Indore</span></h2>
            <img src="images/finalbanklogo.png">
    ...
    <div class="footer-bottom">
        <p class="footer-content">@2021, made by <a href="devloper.html">Suraj Mujalde</a></p>
    </div>
</section>
</body>
</html> 
